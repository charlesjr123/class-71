...
export default class TransactionScreen extends React.Component {
    ...
    bookissue=async()=>{
      ...
      db.collection("student").doc(this.state.scannedStudentId).update({
        #ofbooksissued:firebase.firestore.FieldValue.increment(1)
      })
      alert("bookissued")
      this.setState({
        scannedBookId:"",
      ...
      if (buttonState !== "normal" && hasCameraPermissions){
        ...
        return(
          <View style={styles.container}>
            <View>
              <Image
                source={require("../assert2/asserts/booklogo.jpg")}
            ...
            <TouchableOpacity style={styles.createButton} onPress={this.handletransactions}>
